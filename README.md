...
This project analyzes customer attrition for a credit card company using **MySQL**, **Power BI**, and **DAX** to identify key drivers of customer churn and deliver actionable business recommendations through an executive dashboard.
...
The project follows a complete analytics workflow, including data cleaning, validation, exploratory SQL analysis, KPI development, dashboard design, and business recommendations.
